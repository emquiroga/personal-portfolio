...
export default function WorkAndStudies(props) {
    return (
        <section className="work-and-studies">
            ...
            <p>
            While I'm starting my carreer as a frontend dev, I'm leaving behind almost ten years as a gastronomic worker. That experience will keep on me, powering my compromise and responsability at work.
            </p>
